...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y --no-install-recommends python3.6 python3.7 python3.8 python3.8-venv python3.9 python3.10 python3.11 python3.12
